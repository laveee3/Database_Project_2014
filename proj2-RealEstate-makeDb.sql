...
insert into property values (40011, 20004, 10004, 'Townhouse', 'Y', 'Rent', 	'6003', 'Ganga Dr ',    'Austin', 'TX', '78745', 'USA');
insert into property values (40012, 20004, 10004, 'Townhouse', 'Y', 'Private Sale', 	'6023', 'Ganga Dr ',    'Austin', 'TX', '78745', 'USA');

create table Client (
	Client_id	NUMBER(5),
	property_id	NUMBER(5) references Property(property_id),
	phone_number 	NUMBER(10),
	client_tyoe	VARCHAR(20),
	first_name	VARCHAR(15),
...
insert into Client values (30001, 40001, 5129008001, 'Buyer','Mickey',    'Tana',  'M',  'micky@gmail.com', 	'1100', 'Tinita Dr ', 	'Austin', 'TX', '78756', 'USA');
insert into Client values (30002, 40002, 5129008002, 'Buyer','Minnie',    'Rana',  'F',   'mini@gmail.com',	'2110', 'Stassney St ', 'Austin', 'TX', '78757', 'USA');
insert into Client values (30003, 40003, 5129008003, 'Buyer','Donald',   ' Dixon', 'M',  'dduck@gmail.com', 	'3000', 'Pinkney Dr', 	'Austin', 'TX', '78757', 'USA');
insert into Client values (30004, 40004, 5129008004, 'Buyer','Goofy',     'Sana',  'M',  'goofy@gmail.com', 	'4000', 'Ginita Dr ', 	'Austin', 'TX', '78759', 'USA');
insert into Client values (30005, 40005, 5129008005, 'Buyer','Pluto',     'Landay', 'M', 'pluto@gmail.com', 	'7002', 'Davis Lane ', 	'Austin', 'TX', '78746', 'USA');
insert into Client values (30006, 40006, 5129008011, 'Renter','John',      'Wana',  'M',  'mjohn@gmail.com', 	'1440', 'Buvana Dr ', 	'Austin', 'TX', '78756', 'USA');
insert into Client values (30007, 40007, 5129008022, 'Renter','Jack',      'Jana',  'M',   'jack@gmail.com',	'2550', 'Stassney St ', 'Austin', 'TX', '78757', 'USA');
insert into Client values (30008, 40008, 5129008033, 'Renter','Jill',      'Nixon', 'F',  'jill@gmail.com', 	'3660', 'Wisteria Dr', 	'Austin', 'TX', '78757', 'USA');
insert into Client values (30009, 40009, 5129008044, 'Renter','Gregoria',  'Gomez', 'F',  'gomez@gmail.com', 	'4770', 'Huffman lane', 'Austin', 'TX', '78759', 'USA');
insert into Client values (30010, 40010, 5129008055, 'Renter','Kaif',      'Kapoor','M', 'kkaif@gmail.com', 	'8802', 'Harvard Dr ', 	'Austin', 'TX', '78746', 'USA');
insert into Client values (30011, 40011, 5129008065, 'Landlord','Shyma',      'Perry','F', 'shyma@gmail.com', 	'9002', 'Palani Dr ', 	'Austin', 'TX', '78746', 'USA');
insert into Client values (30012, 40012, 5129008075, 'Seller','Sheila',      'Bill','F', 'sheila@gmail.com', 	'5502', 'Muruga Dr ', 	'Austin', 'TX', '78746', 'USA');
...
create table Buyer(
	Client_id	NUMBER(5) REFERENCES Client(Client_id),
	min_price 	NUMBER(8),
	max_price	NUMBER(8),
	location	VARCHAR(18),
	min_sq_ft	NUMBER(5),
...
insert into Buyer values (30001,  225000, 250000, 'Round Rock',   2200, 2400, 5000, 6000, 2, 2);
insert into Buyer values (30002,  225000, 270000, 'Cedar Park',   2200, 2400, 5000, 6000, 2, 2);
insert into Buyer values (30003,  275000, 290000, 'Shady Hollow', 2200, 2800, 5000, 7000, 2, 2);
insert into Buyer values (30004,  305000, 350000, 'Circle C', 	  3200, 3400, 6000, 8000, 2, 2);
insert into Buyer values (30005,  325000, 360000, 'Great hills',  3200, 3600, 6000, 8000, 2, 2);
...
insert into Renter values (30006, 40006, 1100, '01-01-2013', '01-01-2014', 30011);
insert into Renter values (30007, 40007, 1200, '02-01-2013', '02-01-2014', 30011);
insert into Renter values (30008, 40008, 1300, '03-01-2013', '03-01-2014', 30011);
insert into Renter values (30005, 40005, 1220, '03-01-2013', '03-01-2014', 30011);
insert into Renter values (30009, 40009, 1220, '04-01-2013', '04-01-2014', 30011);
